...
# Link Hosting Kalian
MasWay="raw.githubusercontent.com/Channel-Gratisan/scfull/main/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${MasWay}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${MasWay}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${MasWay}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${MasWay}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${MasWay}/renewssr.sh && chmod +x /usr/bin/renewssr
