...
# Link Hosting Kalian
MasWay="raw.githubusercontent.com/Channel-Gratisan/scfull/main/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://${MasWay}/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://${MasWay}/ws-ovpn.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://${MasWay}/ws-tls
