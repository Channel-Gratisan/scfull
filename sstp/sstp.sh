...
# Link Hosting Kalian
MasWay="raw.githubusercontent.com/Channel-Gratisan/scfull/main/sstp"
...
wget -O /etc/accel-ppp.conf "https://${MasWay}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${MasWay}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${MasWay}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${MasWay}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${MasWay}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
