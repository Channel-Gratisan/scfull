...
# ==================================================
# Link Hosting Kalian
MasWay="raw.githubusercontent.com/Channel-Gratisan/scfull/main/wireguard"
...
echo -e "${Info} Wireguard Script Mod By MasWay"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Channel-Gratisan/scfull/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Channel-Gratisan/scfull/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Channel-Gratisan/scfull/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
